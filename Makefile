...
AVR_FLAGS=-mmcu=$(MCU) -DIHEX_DISABLE_SEGMENTS -DIHEX_MAX_OUTPUT_LINELENGTH=32 -DIHEX_LINE_MAX_LENGTH=64 -DKK_UART_CONVERT_CRLF_IN_TO_LF=1 -DKK_UART_CONVERT_LF_OUT_TO_CRLF=1 -DKK_UART_RECEIVE_BUFFER_SIZE=256 -Iihex -DF_CPU=$(F_CPU) -DBAUD=$(BAUD)
